...
import { Page, Section, optimalTextWidthRem } from './Styles';
    ...
    <Section>
      <div style={{
        ...
        <p>
          ...
          in one basket. We will represent one of the oldest, most
          experienced farms in Sri Lanka — the Ramya Horticulture.
          This top notch farm produces rooted and unrooted
          cuttings as well as an assortment of different potplants
          and they even run their own laboratory.
      </p>
